...
object Dependencies {
  ...
  lazy val googleApiClient = "com.google.api-client" % "google-api-client" % "2.8.1"
  lazy val googleOauthClient = "com.google.oauth-client" % "google-oauth-client-jetty" % "1.39.0"
  lazy val googleApiMail = "com.google.apis" % "google-api-services-gmail" % "v1-rev20251201-2.0.0"
  lazy val jakartaMail = "com.sun.mail" % "jakarta.mail" % "2.0.2"
